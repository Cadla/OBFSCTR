        ...
        private string GetMemberSignature(IMemberDefinition member)
        {
            switch (member.MetadataToken.TokenType)
            {
                ...
                case TokenType.Field:                    
                    return ((FieldDefinition)member).FieldType.FullName;
                case TokenType.Property:
                    return ((PropertyDefinition)member).PropertyType.FullName;
                case TokenType.Event:
                    return ((EventDefinition)member).EventType.FullName;
                default:
                    return String.Empty;
            }
        }
