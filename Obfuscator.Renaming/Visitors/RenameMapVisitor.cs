...
namespace Obfuscator.Renaming.Visitors
{
    ...
    {       
        ...
        {
            var newName = _renamer.MapNewName(resource);
            logRenamingResource(resource, newName);
        }

        private void Rename(IMemberDefinition member)
        {
            var newName = _renamer.MapNewName(member);
            logRenamingMember(member, newName);
        }
        ...
        partial void logRenamingMember(IMemberDefinition member, string newName);
